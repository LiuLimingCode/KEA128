...
/****************** 引脚选择 ******************/
#define MENU_BUTTON_UP          KU          //上按键
#define MENU_BUTTON_DOWN        KD          //下按键
#define MENU_BUTTON_LEFT        KL          //左按键
#define MENU_BUTTON_RIGHT       KR          //右按键
#define MENU_BUTTON_CONFIRM     KC          //确认按键
#if MENU_ENABLE_BUZZER
#define MENU_BUZZER             BUZZ        //蜂鸣器,若MENU_ENABLE_BUZZER为0,可以不设置
#endif
