...
#define OLED_SCLH 	FGPIOA->PDOR |=  ((uint32)1<<PTn(OLED_SCL_Pin))
#define OLED_SCLL 	FGPIOA->PDOR &= ~((uint32)1<<PTn(OLED_SCL_Pin))

#define OLED_SDAH 	FGPIOB->PDOR |=  ((uint32)1<<PTn(OLED_SDA_Pin))
#define OLED_SDAL 	FGPIOB->PDOR &= ~((uint32)1<<PTn(OLED_SDA_Pin))

#define OLED_RSTH 	FGPIOB->PDOR |=  ((uint32)1<<PTn(OLED_RES_Pin))
#define OLED_RSTL 	FGPIOB->PDOR &= ~((uint32)1<<PTn(OLED_RES_Pin))

#define OLED_DCH  	FGPIOB->PDOR |=  ((uint32)1<<PTn(OLED_DC_Pin))
#define OLED_DCL  	FGPIOB->PDOR &= ~((uint32)1<<PTn(OLED_DC_Pin))
